...
# Constants
DATASET_FOLDER_PATH=r'/home/bn/813/LTEDeepLearning/5Gdataset/5G-production-dataset/Netflix/Static/animated-RickandMorty'
INPUT_FILE_PATH = DATASET_FOLDER_PATH +  r'/B_2019.11.26_09.27.10.csv'
OUTPUT_FILE_PATH= DATASET_FOLDER_PATH +  r'/5G-out.csv'
...
DEBUG=0
SLOW_DEBUG=0
PING_AVG_KEY='PINGAVG'
PINGMIN_KEY='PINGMIN'
PINGMAX_KEY='PINGMAX'
PINGSTDEV_KEY='PINGSTDEV'
PINGLOSS_KEY='PINGLOSS'
CELLHEX_KEY='CELLHEX'
NODEHEX_KEY='NODEHEX'
LACHEX_KEY='LACHEX'
RAWCELLID_KEY='RAWCELLID'
...
def create_dataset():
    ...
    dataset.drop(columns=[STATE_KEY, SPEED_KEY, CELL_ID, NETWORK_MODE_KEY, OPERATOR_NAME_KEY, NR_RX_RSRP, NR_RX_RSRQ, PING_AVG_KEY, PINGMIN_KEY, PINGMAX_KEY, PINGSTDEV_KEY, PINGLOSS_KEY ,CELLHEX_KEY , NODEHEX_KEY, LACHEX_KEY, RAWCELLID_KEY], inplace=True)
...
max_row = pd.Series({ DOWNLOAD_BITRATE_KEY: 1000000,
                      ...
                      CQI_KEY:30,
                      RSSI_KEY:-50,
                      UPLOAD_BITRATE_KEY: 500000}, dtype='float')
...
min_row = pd.Series({ DOWNLOAD_BITRATE_KEY: 0,
                      ...
                      CQI_KEY:0,
                      RSSI_KEY:-100,
                      UPLOAD_BITRATE_KEY: 0}, dtype='float')
